...
ここでは、開発体感セミナー向けの[Webアプリケーション](https://github.com/tisicon/tisicon12)を実際に動かしてプログラミングができるようになるためのステップを紹介します。
...
EdgeやSafariをお使いの方は、自分のPCに[Google Chrome](https://www.google.com/intl/ja/chrome/gsem/download/?brand=YTUH&gclid=EAIaIQobChMI4fnFyaPKggMV9dAWBR1dLA90EAAYASAAEgLaUfD_BwE&gclsrc=aw.ds)をダウンロードください。

**以降の作業は、Chromeで実施してください。**  
※EdgeやSafariでは動作が安定しないケースがあります。必ず、ブラウザはChromeとしてください。
...
フローチャートや図を作成するための作図ツールです。

- [draw.ioの準備](content/drawio.md)
...
- [Webアプリケーションの基礎知識](content/learning.md)
